...
with tab8:
    ...
    # === Weight Allocation Over Time Plot
    st.markdown("### 📊 Portfolio Allocation Between SPY and TLT Over Time")
    ...
    weight_fig.update_layout(
        title="Investor Allocation to SPY vs TLT Over Time (Driven by F&G Index)",
