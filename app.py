...
with tab9:
    ...
    - **Our F&G Index (displayed above) uses CNN-style percentile normalization**.
    - The ML-based strategy (below) uses z-score normalization.
    ...
    try:
        ...
        # CNN-style percentile normalization for the displayed F&G index
